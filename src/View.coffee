do ->
  ...
  ERROR_NO_GETTERS = "Meteor.View: You're using elements maps in an unsupported browser! Take care the browser supports setting getters by calling \"Object.defineProperty\""
  ...
  class View
    ...
    constructor: (@name) ->
      ...
      unless @elements is null
        throw new Error ERROR_NO_GETTERS if typeof Object.defineProperty isnt "function"
